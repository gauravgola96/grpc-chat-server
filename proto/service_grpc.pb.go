...
func (x *servicesChatServiceClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *servicesChatServiceClient) Recv() (*Response, error) {
	m := new(Response)
...
func (x *servicesChatServiceServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *servicesChatServiceServer) Recv() (*Request, error) {
	m := new(Request)
